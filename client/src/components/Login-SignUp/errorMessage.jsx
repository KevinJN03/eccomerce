export default function ErrorMessage({ msg, className }) {
    return (
        ...
        >
            <div className="promo-error border-1 relative  flex w-full border-red-500 border-[thin] bg-red-100 p-3">
...
export function ErrorMessagePointerUp({ msg, className }) {
    return (
        ...
        >
            <div className="promo-error border-1 relative top-[-5px] z-10 flex w-full border-red-500 border-[thin] bg-red-100 p-2 w-full">
                ...
                <p className="!w-full  font-light tracking-wider ">{msg}</p>
            </div>
        </section>
    );
}
