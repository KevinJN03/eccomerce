...
const closeMenu = () => {
  ...
  return (
    <section className='mobile-nav'>
      <div className={sideBar ? "opacity-0" : "burger"} onClick={() => openMenu()}>
         <MenuRoundedIcon className='filter icon'/>
      </div>
 ...
 <Nav_Options sideBar={sideBar} closeMenu={closeMenu} />
     ...
     <div className={`backdrop ${sideBar && 'backdrop-open'}`} onClick={()=> closeMenu()}>
