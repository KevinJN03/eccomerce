  ...
  return (
    <header className="header">
      ...
      <section id="search-input-section">
        <input type="text" id="search-input" onChange={search} placeholder="Search for items"/>
      ...
      <section id="icons-wrapper">
        <div id="header-icons" className="header-icon">
          <img src={profile} alt="profile icon" className="img-icon"></img>
        </div>
        <div id="header-icons" className="header-icon">
          <img src={heart} alt="heart icon" className="img-icon"></img>
        </div>
        <div id="header-icons" className="header-icon">
          <img src={basket} alt="basket icon" className="img-icon scale-200"></img>
        </div>
      </section>
    </header>
  );
