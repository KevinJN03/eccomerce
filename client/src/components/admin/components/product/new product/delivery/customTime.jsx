    ...
    return (
        <>
            <span className=" mt-3 flex w-full flex-row items-center justify-end gap-6">
                <input
                    type="number"
                    className="border-1 daisy-select daisy-select-bordered daisy-select-md w-16 rounded px-3 py-2"
            ...
            <span className="mt-1 flex w-full flex-row justify-end gap-2">
                ...
                <input
                    type="radio"
                    defaultChecked={
                        processingTime && processingTime.type == 'days'
                    }
                    id="days"
                    name="dayorweek"
                    value="days"
                ...
                <input
                    ...
                    value="weeks"
                    defaultChecked={
                        processingTime && processingTime.type == 'weeks'
                    }
                    onChange={(e) => updateType(e.target.value)}
                />
            </span>
