        ...
        <section className="variation-manage relative flex min-h-full w-full flex-col">
            ...
            {notDisabled < 2 && (
                <button
                    ...
                    className="border-[2px] mb-4 mt-3 box-border flex max-w-fit flex-row flex-nowrap items-center justify-start self-start rounded-full border-black px-3 py-3 transition-all ease-in-out hover:!px-5"
                >
