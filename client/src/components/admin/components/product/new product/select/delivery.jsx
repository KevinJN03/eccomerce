...
function Test({profile}) {
    ...
    return(
        <>
        <form>
            <Input label={"Name"} id="name" defaultValue={profile.name}/>
...
<div className="popover border-none">
	<label className="popover-trigger" tabIndex="0">{icon}</label>
	<div className="popover-content popover-left-bottom bg-white" tabIndex="0">
		<div className="popover-arrow"></div>
		<button className="hover:bg-slate-100" onClick={() => setContent(<Test profile={profile}/>)}>Edit</button>
                    ...
                    return (
                        ...
                        >
                            <div className="profile-info">
                                ...
                                <p>
                                    {profile.active_listings} Active Listing
                                </p>
                            </div>
                            <section id="profile-btn" className='flex justify-center items-center'>
                                <button>Apply</button>
                                <Popover icon={<MoreHorizRoundedIcon/>} profile={profile}/>
