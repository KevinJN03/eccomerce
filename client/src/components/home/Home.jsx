...
function Home() {
  ...
  const section_4_images = [
    {url: sale_banner_4_image1, text: "glamo design" },
    {url: sale_banner_4_image2, text: "COLLUSION X"},
    {url: sale_banner_4_image3, text: "Recaimed Vintage"},
    {url: sale_banner_4_image4, text: "In Fashion" },
   ];
