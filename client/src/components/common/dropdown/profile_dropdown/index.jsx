...
function Profile_Dropdown({}) {
    return (
        <section
            id="profile_dropdown" className="m-0"
        >
            ...
            <Dropdown_Option option={{src: dashboard_icon, text: "Dashboard"}}/>
            <Dropdown_Option option={{src: order_icon, text: "My Order"}}/>
            <Dropdown_Option option={{src: return_icon, text: "My Returns"}}/>
            <Dropdown_Option option={{src: info_icon, text: "Return Information"}}/>
            <Dropdown_Option option={{src: chat_icon, text: "Contact Preference"}}/>
        </section>
    );
}
