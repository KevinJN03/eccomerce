...
const genderFromLocal = JSON.parse(localStorage.getItem('genderCategory') || JSON.stringify({gender: 'men'}));
...
return {
    ...
    productCategory: action.productCategory
        ...
        throw Error('Unknown action type, check useGenderCategory Rrducer');
    }
}
