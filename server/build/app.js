...
var _couponRoute = _interopRequireDefault(require("./Routes/couponRoute.js"));
var _searchRoute = _interopRequireDefault(require("./Routes/searchRoute.js"));
var _giftCardRoute = _interopRequireDefault(require("./Routes/giftCardRoute.js"));
var _webhookRoute = _interopRequireDefault(require("./Routes/webhookRoute.js"));
...
var _deliveryRoute = _interopRequireDefault(require("./Routes/deliveryRoute.js"));
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable no-console */ /* eslint-disable import/no-extraneous-dependencies */
...
app.use('/api/coupon', _couponRoute["default"]);
app.use('/api/category', _categoryRoute["default"]);
app.use('/api/search', _searchRoute["default"]);
app.use('/api/giftcard', _giftCardRoute["default"]);
app.use('/api/user', _userRoute["default"]);
app.use('/api/admin', _adminRoute["default"]);
app.use('/api/order', _orderRoute["default"]);
app.use('/api/delivery', _deliveryRoute["default"]);
app.use('/api/webhook', _webhookRoute["default"]);
app.get('/api/test', (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var props, emailHtml, mailOptions;
...
var httpOptions = {
  key: _fs["default"].readFileSync('./mkcert/key.pem'),
  cert: _fs["default"].readFileSync('./mkcert/cert.pem'),
  requestCert: false,
...
var sslServer = _https["default"].createServer(httpOptions, app);
