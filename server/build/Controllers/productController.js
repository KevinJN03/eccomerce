...
exports.update_product = exports.get_single_product = exports.get_single_admin_product = exports.get_all_products = exports.getVariations = exports.delete_product = exports.delete_many_product = exports.create_new_product = void 0;
...
var _productValidator = _interopRequireDefault(require("../utils/productValidator.js"));
...
var _sortCOmbineVariations = _interopRequireDefault(require("../utils/sortCOmbineVariations.js"));
...
var get_all_products = exports.get_all_products = (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _product["default"].find().populate('category').exec();
        case 2:
...
var get_single_admin_product = exports.get_single_admin_product = (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
...
var get_single_product = exports.get_single_product = (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          id = req.params.id;
          _context3.next = 3;
          return _product["default"].findById(id).populate({
            path: 'category',
            populate: [{
              path: 'men',
              perDocumentLimit: 10,
        ...
        case 6:
          ...
          isVariationsPresent = _lodash["default"].has(newProducts, 'variations');
          ...
          if (variations.length < 3) {
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                hasPriceProperty = _lodash["default"].has(value, 'price');
                if (hasPriceProperty) {
        ...
        case 26:
          if (i == 2 && combine && variations.length == 3) {
            _sortCombineVariation = (0, _sortCOmbineVariations["default"])(options), variationObj = _sortCombineVariation.variationObj, minPriceValue = _sortCombineVariation.minPriceValue, variation1 = _sortCombineVariation.variation1, variation2 = _sortCombineVariation.variation2;
...
var delete_product = exports.delete_product = (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
...
var delete_many_product = exports.delete_many_product = (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
      ...
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          deleteProductsImages = idArr.map(function (item) {
            return (0, _s3Service.s3Delete)('products', item);
          });
          _context5.next = 5;
          return Promise.all([_product["default"].deleteMany({
            _id: idArr
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 15:
          ...
          item = _step2.value;
          _context9.next = 19;
          return (0, _sharpify["default"])(item);
        case 19:
...
var create_new_product = exports.create_new_product = [upload.array('files', 6), _productValidator["default"], ( /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          resultValidation = (0, _expressValidator.validationResult)(req);
        ...
        case 15:
          _context6.next = 17;
          return (0, _s3Service["default"])(sharpResult, false, newProduct.id);
        case 17:
          _context6.next = 19;
        ...
        case 22:
          ...
          _context6.next = 27;
          return (0, _s3Service.s3Delete)('products', deleteId);
        case 27:
...
var update_product = exports.update_product = [upload.array('files', 6), _productValidator["default"], (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 13:
          ...
          _context7.next = 16;
          return (0, _s3Service.s3Delete)('products', id);
        case 16:
          _context7.next = 18;
          return (0, _s3Service["default"])(sharpResult, false, id);
        case 18:
          newPrice = {
        ...
        case 25:
          _context7.next = 27;
          return _product["default"].findByIdAndUpdate(id, _objectSpread({}, productData), {
            upsert: true
          });
        case 27:
...
var getVariations = exports.getVariations = (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
