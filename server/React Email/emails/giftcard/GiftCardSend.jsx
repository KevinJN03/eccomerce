              ...
              <Column align="center" className="min-w-full p-5">
                <Container className="bg-white p-4 ">
                  ...
                  <Text className="p-4 text-xl">
                    It’s your lucky day! A special Glamo gift card has been sent
                    your way, and we can’t wait for you to discover what’s in
                    store.
                  </Text>
                  <Hr />
                  <Row>
            ...
            <Row className="">
              <Column className=" bg-[#dedfe4] px-8 py-4 " align="center">
                ...
                <Text className="text-left">
                  ...
                  code and apply it to see your balance deducted from the total
                  amount.
                </Text>
                <Text className="text-left">
