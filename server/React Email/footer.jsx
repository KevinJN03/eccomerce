    ...
    <Container className="bg-[#333333] text-white p-5 !min-w-[600px] max-w-[600px] w-full">
      <Section>
                  ...
                  return (
                    ...
                    >
                      <Img
                        ...
                        style={imgStyle}
                        className={`${
                          shinkIcon ? '!w-[60%] !h-[60%]' : 'w-full h-full'
        ...
        <Text className="pt-10 text-xs leading-4">
          *GLAMO has estimated this date on the basis of your expected delivery
          date and the refunds window applicable to your jurisdiction. Please
          see website T&Cs for more details on returns and refunds, and for the
          refunds window applicable to your jurisdiction.
        </Text>
        ...
        <Text className="text-xs leading-4">
          We’ll always keep your data safe and secure. Click here to know why we
          need it and how we use it.
        </Text>
        {/* </Row> */}
      </Section>
    </Container>
