...
import variationOption from '../Models/variationOption.js';
import { v4 } from 'uuid';
import { productInfoPipeline } from '../utils/productInfoPipeline.js';
...
export const beta_get_single_product = [
  ...
  asyncHandler(async (req, res, next) => {
    ...
    //OLD PIPELINE
    // const old_products = await Product.aggregate([
    //   {
    //     $match: { _id: new mongoose.Types.ObjectId(id) },
    //   },
    ...
    //   // {
    //   //   $group: {
    //   //     _id: '$options.variation',
    //   //   },
    //   // },

    //   /// new data format ends
    ...
    //   {
    //     $group: {
    //       // Group by document ID and create a combined array
    //       _id: '$_id',
    ...
    //                         options: {
    //                           $map: {
    //                             input: '$combineVariationOptions',
    //                             as: 'element',
    //                             in: { $arrayElemAt: ['$$element', 1] },
    //                           },
    //                         },
    //                       },
    //                     ],
    ...
    //                     $size: {
    //                       $ifNull: [
    //                         // if array is null, set to an empty array in order to ultimately set the value to false.
    //                         '$variation_data.combineVariation.options',
    //                         [],
    //                       ],
    //                     },
